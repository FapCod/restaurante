...
<nav class="shadow sticky top-0 z-50 " x-data="{ open: false }" style="background-color: #d9b224">
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <a href="/" class="flex-shrink-0 flex items-center">
                    <img class="block lg:hidden h-8 w-auto" src={{ asset('img/logo.png') }}>>
                    ...
                    <div class="ml-3 relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-on:click.away=" open = false " :class="{ 'block': open, 'hidden': !open }"
                            ...
                            <a href="{{ route('profile.show') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-800 hover:text-gray-50"
